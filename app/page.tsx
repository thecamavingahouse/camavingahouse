...
const T = {
  fr: {
    ...
    footerContactLabel: 'Contact', footerCopyright: 'Tous droits r\u00e9serv\u00e9s.',
  },
  es: {
  ...
  en: {
    ...
    salonBadge: 'Our Shops', salonH2a: 'The shop', salonH2b: 'you keep coming back to.',
    salonP: 'Born in 2023 from a passion for the craft done right. A bold identity, uncompromising service, and a clear vision \u2014 built to last and deliver a barbershop experience like no other.',
    ...
    approcheLabel: 'Our Approach', approcheH2a: 'Not just a barbershop.', approcheH2b: 'A statement.',
    approcheP: 'Since 2023, one conviction: consistency, structure, and excellence. Because you deserve the best \u2014 every single time.',
    piliers: [
    ...
    ctaTag: 'Camavinga House \u00b7 Rennes \u00b7 Madrid',
    ctaH2a: 'Ready for', ctaH2b: 'the upgrade?',
    ctaP: 'Book online in seconds \u2014 pick your barber, pick your slot, show up sharp.',
    ctaBtn: 'Book now',
    ...
    modeleP: 'We work with entrepreneurs who share our values and our passion for the craft. Each Camavinga House franchise blends local character with the power of a unified brand.',
...
const ADDRESSES = [
  {
    ...
    hours: [
      ...
      { day: 'Samedi',   time: '10h-14h / 15h-20h' },
    ...
    <main ref={revealRef} className="bg-[#050505] overflow-x-hidden grain-overlay">
      ...
      <section id="salon" className="relative">
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 py-20 sm:py-32 lg:py-40 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="flex flex-col gap-5 sm:gap-7 order-2 lg:order-1">
            <span data-reveal data-reveal-delay="0" className="text-[13px] sm:text-[14px] font-bold uppercase tracking-[0.25em] text-gold/70">
              {t.salonBadge}
            </span>
      ...
      <section className="bg-[#080808]">
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 py-16 sm:py-20">
          <span data-reveal className="text-[13px] sm:text-[14px] font-bold uppercase tracking-[0.25em] text-gold/70 block mb-10 sm:mb-14">
            {t.addressesLabel}
          </span>
      ...
      <section id="services" className="bg-neutral-950">
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 py-20 sm:py-32">
          ...
          <div data-reveal className="mb-10 sm:mb-16 max-w-2xl">
            <span className="text-[13px] sm:text-[14px] font-bold uppercase tracking-[0.25em] text-gold/70 block mb-5">
              {t.servicesLabel}
            </span>
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 py-20 sm:py-32">
          <div className="grid lg:grid-cols-[2fr_3fr] gap-12 lg:gap-20 items-start">
            <div data-reveal="left">
              <span className="text-[13px] sm:text-[14px] font-bold uppercase tracking-[0.25em] text-gold/70">
                {t.approcheLabel}
              </span>
